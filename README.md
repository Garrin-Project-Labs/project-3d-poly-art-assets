...
Project workspace for the Discord-bound OpenClaw agent `poly-art-assets`.

- Discord guild ID: `1515020347425030245`
- Discord channel ID: `1516987814745473024`
- Agent ID: `poly-art-assets`
- Default model: `gpt-5.5`
- Workspace: `/home/garrin/.openclaw/workspace-poly-art-assets`
- Visibility: `public`
- GitHub Pages: `enabled`
- GitHub Pages URL: `https://garrin-project-labs.github.io/project-3d-poly-art-assets/`
- GitHub repo: `Garrin-Project-Labs/project-3d-poly-art-assets` (public)
...
- Viewer: `poly-art-assets-viewer`
- Contributor: `poly-art-assets-contributor`
- Maintainer: `poly-art-assets-maintainer`
