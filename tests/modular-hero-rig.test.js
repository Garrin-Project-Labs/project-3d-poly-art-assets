...
const REQUIRED_BASE_PARTS = ['left_boot', 'right_boot', 'left_leg', 'right_leg', 'hip_belt', 'torso', 'chest_inset', 'left_shoulder', 'right_shoulder', 'left_arm', 'right_arm', 'left_hand', 'right_hand', 'neck', 'head'];
